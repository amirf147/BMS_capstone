...
from settings import test_csv as csv

lines = csv.to_lines() # split csv into list of lines
column_names = csv.column_names
...
f.write(str(column_names)) # add the column names to the first line of file
