...
data4x2_1df = Dataframe('4x2_fullspeed_clean.csv')
data4x2_2df = Dataframe('4x2_fullspeed+stop_clean.csv')
data4x2_3df = Dataframe('4x2_fullspeed+steering_clean.csv')
...
df6 = data4x2_2df.clean()
df7 = data4x2_3df.clean()
...
data4x2_2df.add_time_column(df6, 'm')
data4x2_3df.add_time_column(df7, 'm')

# remove some data outliers from dataframes
df4 = df4.iloc[30:7090]
df6 = df6[df6['Cell 4'] != 0]
df6 = df6.iloc[53::]
df7 = df7[df7['Cell 1'] != 0]
...
data4x2_1_plot = Plot('Cell Voltages: Fullspeed run with 8 cells (4x2)',
                   'Time (minutes)', ['Cell 1', 'Cell 2', 'Cell 3',
                                      'Cell 4'])

data4x2_2_plot = Plot('Cell Voltages: Fullspeed+stops run with 8 cells (4x2)',
                   'Time (minutes)', ['Cell 1', 'Cell 2', 'Cell 3',
                                      'Cell 4'])

data4x2_3_plot = Plot('Cell Voltages: Fullspeed+steering+stops run with 8 cells (4x2)',
                   'Time (minutes)', ['Cell 1', 'Cell 2', 'Cell 3',
                                      'Cell 4'])
...
data4x2_2_plot.set_options(df6, show_plot = True)
data4x2_3_plot.set_options(df7, show_plot = True)
